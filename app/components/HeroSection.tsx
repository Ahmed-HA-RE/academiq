        ...
        <div className='flex flex-col gap-6 lg:col-span-3'>
          ...
          >
            <p className='text-muted-foreground text-lg'>
              ...
              with purpose. We&apos;re here to help you master practical skills,
              gain real confidence, and move forward at your own pace. From
              fundamentals to advanced topics, every course is built to turn
