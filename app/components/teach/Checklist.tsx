      ...
      <div className='container'>
        <div className='mb-10 space-y-4'>
          ...
          >
            ...
            understand their subject well, can explain concepts clearly, and are
            committed to delivering valuable learning experiences. By meeting
            these expectations, teachers help create a trusted environment where
            students feel supported, guided, and confident in their learning
            journey.
          </MotionPreset>
        </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
          ...
          {/* Right Column - Image */}
          <MotionPreset
            className='my-auto sm:h-[400px] lg:h-[600px] col-span-1'
            fade
            delay={0.4}
            transition={{ duration: 1.5 }}
          >
            <Image
              src='https://res.cloudinary.com/ahmed--dev/image/upload/v1766255158/application_hciyt0.png'
