        ...
        <>
          <div className='space-y-4'>
            <p className='text-muted-foreground'>
              ...
              courses accessible to learners worldwide. We bridge the gap
              between knowledge seekers and expert instructors, creating a
              thriving community where learning knows no boundaries. Through our
              platform, we enable anyone to acquire new skills, advance their
              careers, and pursue their passions.
            </p>
            <p className='text-muted-foreground'>
              We believe that education is the foundation of personal and
              professional growth. By continuously improving our platform and
              supporting both learners and instructors, we&apos;re building a
              future where quality education is within everyone&apos;s reach.
            </p>
          </div>
        </>
      ),
