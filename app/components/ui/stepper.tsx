...
function StepperIndicator({
  ...
  return (
    <span
      className={cn(
        'relative flex size-6 shrink-0 items-center justify-center rounded-full bg-gray-200 dark:bg-gray-100 font-medium text-muted-foreground text-xs data-[state=active]:bg-gray-200 data-[state=active]:dark:bg-gray-100 data-[state=completed]:bg-green-500 data-[state=completed]:dark:bg-green-500 data-[state=active]:text-primary-foreground data-[state=completed]:text-primary-foreground',
        className
      )}
