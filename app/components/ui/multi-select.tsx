      ...
      >
        <div className='flex flex-wrap gap-1'>
          {selected.map((option) => {
            return (
              ...
              >
                {option.label}
                <button
                  className='text-muted-foreground/80 hover:text-foreground  absolute -inset-y-px -right-px flex size-7 items-center justify-center rounded-r-md border border-transparent p-0 outline-hidden transition-[color,box-shadow] outline-none'
                  onKeyDown={(e) => {
                    if (e.key === 'Enter') {
          ...
          <button
            ...
            className={cn(
              'text-muted-foreground/80 hover:text-foreground absolute top-0 right-0 flex size-9 items-center justify-center rounded-md border border-transparent transition-[color,box-shadow] outline-none focus-visible:ring-[1px]',
              (hideClearAllButton ||
                disabled ||
                selected.length < 1 ||
